            ...
            if($('.active-chat-board').length==0){
                ...
                if(localStorage.getItem('wpwHitory')){
                    ...
                    if(clickintent=='Faq'){
                        ...
                        var askEmail= handle_language(wp_chatbot_obj.hello)+' '+shopperName+'! '+ wpwKits.randomMsg(wp_chatbot_obj.asking_email);
                        ...
                        var askEmail=handle_language(wp_chatbot_obj.hello)+' '+shopperName+'! '+ wpwKits.randomMsg(wp_chatbot_obj.asking_phone);
                        setTimeout(function(){
                            wpwMsg.single(askEmail);
                            //Now updating the support part as .
        ...
        if ($('#wp-chatbot-shortcode-template-container').length == 0 && $('#wp-chatbot-chat-app-shortcode-container').length == 0) {
            ...
            if (widowW > 767) {
                if(wpChatBotVar.template=='template-06' || wpChatBotVar.template=='template-07'){
                    ...
                    var ballConH = parseInt(widowH * 0.5) + parseInt(73);
                }
                ...
                if( wpChatBotVar.start_menu_installed && wpChatBotVar.template!='template-05' && ( typeof(wpbotshortcodetemplate)==="undefined" || wpbotshortcodetemplate!='template-05' ) ){
                    if($('.active-chat-board').length>0){
                        ...
                        if( widowW <= 768 && wpChatBotVar.mobile_full_screen==1 && typeof(iframe_exists)==="undefined" ){
                            ...
                            $('.wpbot-saas-live-chat').height( $(window).height() );
                            if( $('.wbcaBody').length > 0 ){
                                $('.wbcaBody').css( "height", ($(window).height()-30)+"px" )
                            }	
                            if( $('#wbca_chat_body').length > 0 ){
                                $('#wbca_chat_body').css( "height", ($(window).height()-73)+"px" )
                            }
                        }else{
                            $('.wp-chatbot-start-container').width( maincontainerwidth );
                            $('.wp-chatbot-start-container').height( maincontainerheight );
            ...
            $(document).on('click', '#wp-chatbot-mobile-close, #wp-chatbot-desktop-close, #wp-chatbot-desktop-close1, .wp-chatbot-start-close', function (event) {
                if( $('.wp-chatbot-start-container').is(':visible') ){
                    $('.wp-chatbot-start-container').hide();
                    $('#wp-chatbot-integration-container .wp-chatbot-integration-button-container').show();
                }
